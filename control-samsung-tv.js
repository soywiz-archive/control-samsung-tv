...
function getSamsungDevices(timeMs = 250) {
...
async function getCachedSamsungDevices() {
...
const main = async () => {
    ...
    while (true) {
        ...
        switch (key) {
            case '0':
                await remote.sendKey(Keys.KEY_0);
                break;
            case '1':
                await remote.sendKey(Keys.KEY_1);
                break;
            case '2':
                await remote.sendKey(Keys.KEY_2);
                break;
            case '3':
                await remote.sendKey(Keys.KEY_3);
                break;
            case '4':
                await remote.sendKey(Keys.KEY_4);
                break;
            case '5':
                await remote.sendKey(Keys.KEY_5);
                break;
            case '6':
                await remote.sendKey(Keys.KEY_6);
                break;
            case '7':
                await remote.sendKey(Keys.KEY_7);
                break;
            case '8':
                await remote.sendKey(Keys.KEY_8);
                break;
            case '9':
                await remote.sendKey(Keys.KEY_9);
                break;
            case '\u001b[A':
                await remote.sendKey(Keys.KEY_UP);
                break;
            case '\u001b[B':
                await remote.sendKey(Keys.KEY_DOWN);
                break;
            case '\u001b[C':
                await remote.sendKey(Keys.KEY_RIGHT);
                break;
            case '\u001b[D':
                await remote.sendKey(Keys.KEY_LEFT);
                break;
            case '\u007f':
                await remote.sendKey(Keys.KEY_BACK_MHP);
                break;
            case '\u001b':
                await remote.sendKey(Keys.KEY_HOME);
                break;
            ...
            case '\r':
                ...
                break;
            case 'p':
                await remote.sendKey(Keys.KEY_PLAY);
                break;
            case '+':
                await remote.sendKey(Keys.KEY_VOLUP);
                break;
            case '-':
                await remote.sendKey(Keys.KEY_VOLDOWN);
                break;
            case 'w':
                await remote.sendKey(Keys.KEY_CHUP);
                break;
            case 's':
                await remote.sendKey(Keys.KEY_CHDOWN);
                break;
            case 'q':
